...
- Add a configurable regional smoke-test SLURM helper using the local launcher for account, partitions, paths, and controller email notifications.
...
- Add a checked-in generic site configuration template and reproducible regional smoke-test helper to replace repeated interactive path exports.
